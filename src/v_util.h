...
void rt_intersection (float r1, float theta1, float r2, float theta2, int *x,
		      int *y);
...
namespace morphology
{
  ...
  int *open_operation (int *buf, int w, int h, int *num_out, int startx,
		       int starty, int cw, int ch, int *cx, int *cy);
};
